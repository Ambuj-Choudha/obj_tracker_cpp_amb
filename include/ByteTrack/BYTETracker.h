...
// Original file: include/ByteTrack/BYTETracker.h
// License: MIT (see upstream repository LICENSE)
// Reason for vendoring: this project has no package manager for C++ deps, so
// the ByteTrack sources are copied verbatim into include/ByteTrack and
// src/ByteTrack and built as part of obj_tracker_lib. No local modifications.
// -----------------------------------------------------------------------------
